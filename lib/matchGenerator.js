          ...
          for (let k = j + 1; k < n - 1; k++) {
            for (let l = k + 1; l < n; l++) {
              ...
              for (const [team1, team2] of teamOptions) {
                ...
                // Score: prioritize new partnerships (100x), minimize games spread (-1x), minimize rest spread (-0.5x)
                const score = newPartnershipsCount * 100 - gamesSpread * 1 - restSpread * 0.5;
