...
export function useBulkOperations() {
  ...
  // Update gender of a parsed player before adding
  const updateParsedPlayerGender = useCallback((playerId, newGender) => {
    setParsedBulkPlayers((prev) =>
      prev.map((p) =>
