...
export function useTournamentLogic() {
  ...
  const advanceToNextRound = useCallback((bracketToUse = null) => {
    ...
    if (bracket.format === 'group-knockout' && bracket.stage === 'group') {
      console.log('[advanceToNextRound] Transitioning from group to knockout stage');
    ...
    console.log('[advanceToNextRound] Updated bracket total rounds:', updated.rounds.length);
