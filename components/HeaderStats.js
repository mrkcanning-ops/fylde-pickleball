      ...
      {stats.map((stat, idx) => (
        <div
          ...
          className={`p-5 rounded-2xl shadow-lg select-none transition-all duration-300 transform hover:-translate-y-1 hover:scale-105
            ...
            } ${stat.onClick ? "cursor-pointer ring-2 ring-yellow-400/30 hover:ring-yellow-300" : ""} ${stat.label === "Division" ? "h-44" : "h-32"} flex flex-col justify-center`}
        >
                  ...
                  className={`p-5 rounded-2xl shadow-lg select-none transition-all duration-300 transform hover:-translate-y-1 hover:scale-105
                    ${
                      stat.label === "Current Leader"
                        ...
                        ? "bg-gray-700 text-gray-300 hover:bg-gray-600"
                        : "bg-gray-700 text-gray-300"
                    } ${stat.onClick ? "cursor-pointer ring-2 ring-yellow-400/30 hover:ring-yellow-300" : ""} ${stat.label === 'Division' ? 'h-40' : 'h-32'} flex flex-col justify-center`}
                >
                  />
                ))}
              </div>
