  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-900">
      <div className="text-center">
        ...
        <p className="text-xl text-gray-300 mb-12">Competitive League Management</p>
        ...
        <div className="space-y-4 max-w-md">
          ...
          <button
            ...
            className="w-full bg-gray-700 hover:bg-gray-600 text-white font-bold py-4 px-6 rounded-lg text-lg transition-colors"
          >
            View Standings
          </button>
        </div>
